  ...
  foreach my $sample (@$lines) {
    if (defined $$sample{validation_status}){
      if ($$sample{validation_status} eq 'Validated, visible' or $$sample{validation_status} eq 'Validated, not visible'){
        ...
        if (defined $$sample{depositor_cellline_culture_conditions}{culture_medium}){$sample_index->{depositor_cellline_culture_conditions}{culture_medium} = $$sample{depositor_cellline_culture_conditions}{culture_medium};}
        if (defined $$sample{depositor_cellline_culture_conditions}{culture_medium_other}){$sample_index->{depositor_cellline_culture_conditions}{culture_medium_other} = $$sample{depositor_cellline_culture_conditions}{culture_medium_other};}
