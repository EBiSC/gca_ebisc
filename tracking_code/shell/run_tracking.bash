...
&& perl $EBISC_CODE/tracking_code/scripts/add_dates_to_json.pl -new_api_compares_json $TRACK_HOME/$VERSION/api_compares.no_dates.$VERSION.json -old_api_compares_json $TRACK_HOME/api_compares.current.json > $TRACK_HOME/$VERSION/api_errors.$VERSION.json \
