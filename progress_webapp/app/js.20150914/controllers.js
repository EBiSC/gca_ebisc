    ...
    this.sortBy = function(column) {
      this.data.lines.sort(
        column === 'IMSExported' ? function(a,b) {return b.IMS.exported.error - a.IMS.exported.error || a.consensus.name.error - b.consensus.name.error || a.consensus.name.val.localeCompare(b.consensus.name.val)}
          ...
          : column === 'biosampleOther' ? function(a,b) {return b.biosample.batch_line_link.error - a.biosample.batch_line_link.error || b.biosample.batch_donor_link.error - a.biosample.batch_donor_link.error || b.biosample.id.error - a.biosample.id.error || b.donor_biosample.exported.error - a.donor_biosample.exported.error || a.consensus.name.val.localeCompare(b.consensus.name.val)}
          : column === 'LIMS' ? function(a,b) {return b.LIMS.missing_data.error - a.LIMS.missing_data.error || b.LIMS.name_batch_id_consistent.error - a.LIMS.name_batch_id_consistent.error || b.LIMS.batches.length - a.LIMS.batches.length || a.consensus.name.val.localeCompare(b.consensus.name.val)}
