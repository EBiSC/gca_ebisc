...
ebiscProgress.config(['$routeProvider',
  function($routeProvider) {
    $routeProvider.
    when('/', {
      templateUrl: 'partials.20150813/line-list.html',
      controller: 'LineListCtrl',
      controllerAs: 'LineCtrl',
    }).
    when('/errors', {
      templateUrl: 'partials.20150813/errors.html',
      controller: 'ErrorListCtrl',
      controllerAs: 'ErrorCtrl',
    }).
    when('/tests', {
      templateUrl: 'partials.20150813/tests.html',
      controller: 'TestListCtrl',
      controllerAs: 'TestCtrl',
    }).
    when('/:line', {
      templateUrl: 'partials.20150813/line-detail.html',
